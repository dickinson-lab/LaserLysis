/*
 * Source: https://stackoverflow.com/questions/7304017/how-to-add-sexy-on-off-sliders/7308818
 */
package LaserLysis;
    ...
    public JSwitchBox(String trueLabel, String falseLabel) {
        ...
        addMouseListener( new MouseAdapter() {
            ...
            public void mouseReleased( MouseEvent e ) {
                if(new Rectangle( getPreferredSize() ).contains( e.getPoint() ) && isEnabled() ) {
